...
// all the helper functions, post real/imag register reads
		...
		void SaveTPC(unsigned long, unsigned long, unsigned long, unsigned long, unsigned long);
		void ReadTPC(unsigned long, unsigned long, unsigned long, unsigned long, unsigned long);
...
void IA::SaveTPC(unsigned long adr1, unsigned long adr2, unsigned long adr3, unsigned long adr4, unsigned long adr5){
	EEPROM.put(adr1, IMP_DATA.calibration_freq);
	EEPROM.put(adr2, IMP_DATA.gain_factor);
	EEPROM.put(adr3, IMP_DATA.system_phase);
	EEPROM.put(adr4, IMP_DATA.calibration_gf_slope);
	EEPROM.put(adr5, IMP_DATA.calibration_phase_slope);
}

void IA::ReadTPC(unsigned long adr1, unsigned long adr2, unsigned long adr3, unsigned long adr4, unsigned long adr5){
	EEPROM.get(adr1, IMP_DATA.calibration_freq);
	EEPROM.get(adr2, IMP_DATA.gain_factor);
	EEPROM.get(adr3, IMP_DATA.system_phase);
...
void IA::ApplyTwoPointCal(float freq){
	float old = IMP_DATA.gain_factor;
	IMP_DATA.gain_factor = old + (freq - IMP_DATA.calibration_freq) * IMP_DATA.calibration_gf_slope;
	old = IMP_DATA.phase;
	IMP_DATA.phase = old + (freq - IMP_DATA.calibration_freq) * IMP_DATA.calibration_phase_slope;
}
