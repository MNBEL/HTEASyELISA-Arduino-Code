...
public:
	...
	public:
		...
		void CalculateGainFactor(long CalibrationIMP);
		void Impedance();
		void Phase();
		double ZReal();
		double ZImaginary();
		...
		for(int num = 0; num < SParam.sweep_Samples; num++)
		{
			...
			if(SParam.calibration_Flag)
			{
				if(IA_DATA.range < 5)//20 Ohm Feed Back Resistor
				{
					...
					// Serial.print("FBR_100K = ");
					// Serial.println(FBR_100K);
...
* @return:		 none
******************************************************************/
void IA::CalculateGainFactor(long CalibrationIMP)
{
	double gainFactor;
	...
	if(IA_DATA.range < 5){
		...
		// Serial.println("gf_value_100K calc:");
		// Serial.println(magnitude);
		// Serial.println(CalibrationIMP);
...
void IA::Impedance()
{
	...
	magnitude = sqrt(((float)IA_DATA.rVAL * (float)IA_DATA.rVAL) + ((float)IA_DATA.iVAL * (float)IA_DATA.iVAL));
	// Serial.println(magnitude);
	// Serial.println(IA_DATA.gf_value_20, 30);
