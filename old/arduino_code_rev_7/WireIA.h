...
public:
	...
	public:
		...
		void setSweepParameters(int, int, int);
...
void IA::setSweepParameters(int begin_Freq, int f_Step, int nSteps)
{
...
void IA::BeginFrequencySweep()
{
	...
	setSettlingTime(10, 3); // what do these values mean? Should they be dynamic?
