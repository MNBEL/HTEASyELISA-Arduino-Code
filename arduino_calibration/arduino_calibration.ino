...
void setup() {
  ...
  ia.MeasureTwoCalPoint(calibration_imp, 0, 10000, 90000);
  Serial.println("two cal measured");
  Serial.print(ia.IA_DATA.rVAL);
  Serial.print(" ");
  Serial.print(ia.IA_DATA.iVAL);
  Serial.print(" ");
  Serial.print(ia.IMP_DATA.calibration_freq);
  Serial.print(" ");
  Serial.print(ia.IMP_DATA.gain_factor, 20);
  Serial.print(" ");
  Serial.print(ia.IMP_DATA.system_phase);
  Serial.print(" ");
  Serial.print(ia.IMP_DATA.calibration_gf_slope, 20);
  Serial.print(" ");
  Serial.println(ia.IMP_DATA.calibration_phase_slope, 20);
  ia.SaveTPC(0, 10, 20, 30, 40);
  ia.IMP_DATA.calibration_freq = 0;
  ia.IMP_DATA.gain_factor = 0;
  ia.IMP_DATA.system_phase = 0;
  ia.IMP_DATA.calibration_gf_slope = 0;
  ia.IMP_DATA.calibration_phase_slope = 0;
  ia.ReadTPC(0, 10, 20, 30, 40);
  Serial.print(ia.IMP_DATA.calibration_freq);
  Serial.print(" ");
  Serial.print(ia.IMP_DATA.calibration_gain_factor, 20);
  Serial.print(" ");
